...
--
-- Gép: 127.0.0.1:3307
-- Létrehozás ideje: 2026. Feb 11. 08:37
...
INSERT INTO `images` (`id`, `user_id`, `title`, `description`, `upload_date`, `url`, `location_id`) VALUES
(6, 2, 'Izlandi hegység', 'Záridő: kb. 1/60 – 1/125 mp\r\nRekeszérték: f/8 – f/11\r\nISO érzékenység: 100 – 200\r\nGyújtótávolság: kb. 24–35 mm (nagylátószög)\r\nFehéregyensúly: napfény (kb. 5500 K)', '2025-10-27 19:41:21', '/images/1761586881317.jpg', NULL),
(8, 3, 'Görögország', 'Telefonnal csináltam Görög nyaraláson során. Semmi extra beállítás csak egy jól elkapott pillanat.😎\nTelefonom: Samsung Galaxy S25', '2025-11-02 15:25:26', '/images/1762093526424.jpg', NULL),
(9, 4, 'Naplementés Balaton', 'Tavaly nyáron készítettem ezt a naplementés képet a Balatonról a telefonommal.\r\nTelefon: Samsung Galaxy S22', '2025-11-02 15:40:36', '/images/1762094436028.jpg', NULL),
(10, 4, 'Teknős', 'Egyik nyaraláson csináltam ezt a képet erről az aranyos teknősről. Remélem tetszik nektek. A Samsung Galaxy S22-es telefonnal készítettem ezt a képet.', '2025-11-10 11:09:03', '/images/1762769343370.jfif', NULL),
(11, 4, 'Vérhold', '2025 szeptember 7-én látható volt Magyarországon vérhold és ezt próbáltam lencse végre kapni, kisebb nagyobb sikerrel. Ezt a képet egy Iphone 14-el csináltam.', '2025-11-10 11:13:33', '/images/1762769613542.jfif', NULL),
(15, 3, 'Cicám Félix', 'Nem rég tök jól elkaptam a cicámat Félixet miközben feküdt az ágyamon a délutáni alvását végezve. A telefonommal készítettem. (iPhone 12 Pro Max) A hátteret kicsit elhalványítottam, hogy a macska legyen a fókuszba. Írjatok, ha érdekel a beállítások.', '2025-12-16 12:05:35', '/images/1765883135303.jpg', NULL),
(16, 3, 'Túra a Mátrában', '1 hete voltam túrázni a barátaimmal a Mátrában ahol ezt a képet lőttem. Fényképezőgép: Full-frame DSLR, Objektív: 24–70 mm f/2.8, Gyújtótávolság: 35 mm', '2025-12-16 12:10:43', '/images/1765883443941.jpg', NULL),
(17, 3, 'Tábortűz', 'Amikor voltunk a Mátrába túrázni, akkor tettünk egy tábortüzet. Sikerült elkapni egy jó pillanatot.Fényképezőgép: Full-frame DSLR, Objektív: 24–70 mm f/2.8, Gyújtótávolság: 35–50 mm, Záridő: 1/60 s, Rekesz: f/2.8', '2025-12-16 12:14:20', '/images/1765883660781.jpg', NULL),
(19, 6, 'Erdő ösvény', 'Sötét fás ösvény közelről, párás lombokkal. Canon EOS 200D kit objektívvel (18-55mm, f/5.6, ISO 800, 1/100s), kicsit zajos, csak fényerőt emeltem Lightroomban – kezdő hiba a magas ISO-val.\r\n\r\n', '2026-01-21 21:55:30', '/images/1769028930001.jpg', NULL),
(20, 6, 'Mező és erdő', 'Zöld mező távoli erdős háttérrel, kora reggeli fényben. Sony A6000 50mm-rel (f/8, ISO 200, 1/250s), alap tájkép mód, cropoltam csak, nincs utómunka.\r\n\r\n', '2026-01-21 21:56:58', '/images/1769029017995.jpg', NULL),
(21, 6, 'Város repülőből', 'Felhők felett város sziluett. iPhone 13-mal (f/1.6, ISO 64, 1/2000s), mobil appal, Snapseedben csak élességet állítottam.\r\n\r\n', '2026-01-21 21:58:30', '/images/1769029110027.jpg', NULL),
(22, 6, 'Erdő napfényben', 'Napfényben úszó lombos erdő. Nikon D3500 35mm-mel (f/11, ISO 100, 1/125s), tripod nélkül készült, GIMP-ben kis kontrasztot javítottam.\r\n\r\n', '2026-01-21 22:02:47', '/images/1769029367967.jpg', NULL),
(23, 6, 'Út a hegyre', 'Kanyargós út a hegyre. Canon Rebel T7 18-55mm-mel (f/10, ISO 400, 1/160s), kis remegés, Photoshop Expressben szaturációt növeltem.\r\n\r\n', '2026-01-21 22:04:05', '/images/1769029445685.jpg', NULL),
(24, 7, 'Úton Tasnádra', 'Éppen buszúton voltam Tasnádra jó barátom a buszvezető nagyon megbízható :D', '2026-01-21 22:22:33', '/images/1769030553027.jpg', NULL),
(25, 7, 'Fekete-fehérbe is szép az élet!', 'Ismerősömről készítettem fényképet, némi szerkesztéssel. Kérdésed lenne tedd fel hozzászólásba. ', '2026-01-21 22:24:54', '/images/1769030694619.jpg', NULL),
(26, 7, 'Hófehérke', 'Szomszédom enni való kutyusa, kár lett volna kihagyni.', '2026-01-21 22:26:04', '/images/1769030764100.jpg', NULL),
(27, 7, 'Munkás autó', 'Gondoltam készítek erről a szépségről is már egy komolyabb képet. ', '2026-01-21 22:28:31', '/images/1769030911036.jpg', NULL),
(28, 7, 'Cica és napfény', 'Egyik kedvenc képem, gyönyörű a nap sugara a képen, használtam egy kevés szerkesztést.', '2026-01-21 22:33:22', '/images/1769031202923.jpg', NULL),
(29, 8, 'Prága', 'Helyszín: Prague, Czech Republic \r\nKérdésed lenne tedd fel bátran!', '2026-01-21 22:41:47', '/images/1769031707965.jpg', NULL),
(30, 8, 'Lánchíd', 'Éjszakai kilátás a budapesti lánchídról a Dunán', '2026-01-21 22:43:59', '/images/1769031839671.jpg', NULL),
(31, 8, 'Vietnam', 'Nagyon megtetszett, ahogy a zászlókkal színt vittek az épületbe.', '2026-01-21 22:46:29', '/images/1769031989300.jpg', NULL),
(32, 8, 'Oxford, Anglia', 'Különösen szeretem ezt a képet nagyon sok jó emlékem van ebből a városból.', '2026-01-21 22:49:50', '/images/1769032190797.jpg', NULL),
(33, 8, 'Repülőút Spanyolországba', 'Ez a következő utam, ha szeretnétek még onnan is képeket vagy kérdésed lenne írj hozzászólást.', '2026-01-21 22:54:22', '/images/1769032462344.jpg', NULL),
(34, 9, 'Fagy', 'Közeli kép fűről kicsit fagyos, jeges. Canon EOS 800D 50mm makróval (f/4, ISO 400, 1/200s), természetes fényben készült, Lightroomban csak élességet és hideg tónust javítottam.\r\n\r\n', '2026-01-21 23:06:21', '/images/1769033181916.jpg', NULL),
(35, 9, 'Molylepke virágon', 'Molylepke pihenő virágon, finom részletekkel. Sony A6400 85mm-rel (f/5.6, ISO 200, 1/320s), makró mód, minimális kontraszt növelés GIMP-ben, tripod nélkül.\r\n\r\n', '2026-01-21 23:07:33', '/images/1769033253640.jpg', NULL),
(36, 9, 'Kávé', 'Kávéscsésze táblán. Nikon Z50 35mm-mel (f/3.5, ISO 100, 1/60s), természetes ablakfény, Snapseedben a fényerőt állítottam.\n\n', '2026-01-21 23:08:02', '/images/1769033282879.jpg', NULL),
(37, 9, 'Kis crema kávé', 'Apró crema rétegű kávé közelről, textúrával. Fujifilm X-T30 56mm-rel (f/4, ISO 250, 1/125s), konyhai fény, kis szaturáció boost Photoshop Expressben.\r\n\r\n', '2026-01-21 23:09:33', '/images/1769033373679.jpg', NULL),
(38, 9, 'Reggeli ágyban', 'Narancslé és croassant ágyban két személyre. Canon EOS M50 24mm-rel (f/3.2, ISO 160, 1/80s), természetes reggeli fény, crop és enyhe melegítés Lightroomban.\r\n\r\n', '2026-01-21 23:10:23', '/images/1769033423076.jpg', NULL),
(39, 10, 'Divat fotózás', 'Munkám nagyrészt divat, egyéb stúdió fotókat készítek mint például ez, ha érdekel a munkásságom elérhetőségem: tamasszabo.shoot@gmail.com', '2026-01-21 23:19:41', '/images/1769033981885.jpg', NULL),
(40, 10, 'Elgondolkodó portré', 'Fiatal férfi elgondolkodva pózol minimalista környezetben, lágy megvilágítással. Profi setup: Canon EOS R5, 85mm f/1.4L objektív (f/2.8, ISO 100, 1/200s), két Profoto B10 stúdiólámpa (kulcsfény 4300K, kitöltő 5600K), Capture One utómunka: Dodge & Burn, frekvencia alapú szeparáció, bőrtextúra megőrzése, +12% élesség Radius 1.2px.\r\n\r\n', '2026-01-21 23:21:46', '/images/1769034106981.jpg', NULL),
(41, 10, 'Fekete-fehér portré', 'Fekete-fehér portré: drámai kontraszttal és árnyékjátékkal. Profi setup: Canon EOS R6, 50mm f/1.2L objektív (f/4, ISO 100, 1/160s), Profoto A10 vaku + softbox (kulcsfény 1/4 power, háttérlámpa 1/8), Lightroom + Photoshop utómunka: fekete-fehér konverzió (N&B mix: Red +20, Yellow +15), lokális dodge & burn, textúra finomhangolás, élesség Unsharp Mask 120%, Radius 0.8px.', '2026-01-21 23:24:20', '/images/1769034260356.jpg', NULL),
(42, 10, 'Árnyékos alak', 'Fekete-fehér portré: férfi kicsit távolabbról pózol minimalista háttér előtt, ahol látható az árnyéka. Profi setup: Canon EOS R6, 70mm f/2.8L makró objektív (f/5.6, ISO 100, 1/125s), Profoto B1X vaku + octabox (kulcsfény 1/2 power, háttér rim light 1/16), Capture One utómunka: fekete-fehér konverzió (Orange +25, Blue -10), árnyék kiemelés Curves-szal, lokális kontraszt +15%, textúra élesítés High Pass filter 80%, Radius 1.0px.\r\n\r\n', '2026-01-21 23:28:15', '/images/1769034495873.jpg', NULL),
(43, 10, 'Festmények ', 'Legutóbbi munkám. Kontrasztos háttérrel és finom silhouettettel. Profi setup: Canon EOS R5, 135mm f/2L objektív (f/4, ISO 100, 1/160s), Profoto D2 vaku + grid spot (háttér 1/8 power, rim light 1/32), Capture One utómunka: színkorrekció (split toning: árnyékok kék -5, highlights narancs +8), textúra kiemelés Clarity +20, lokális vignette -15%, élesség Output Sharpening 150%, Radius 1.1px.', '2026-01-21 23:31:31', '/images/1769034691609.jpg', NULL),
(45, 1, 'Parti jelenet', 'tegnap csináltam', '2026-02-10 14:36:34', '/images/1770730594624.jpg', NULL);
...
CREATE TABLE `locations` (
  ...
  `source` enum('map_click','places','manual') DEFAULT NULL,
...
ALTER TABLE `images`
  ADD PRIMARY KEY (`id`),
  ADD KEY `user_id` (`user_id`),
  ADD KEY `idx_images_location_id` (`location_id`);
...
ALTER TABLE `locations`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `unique_place_id` (`place_id`),
  ADD KEY `idx_locations_lat_lng` (`lat`,`lng`);
...
ALTER TABLE `images`
  ...
  ADD CONSTRAINT `images_ibfk_location` FOREIGN KEY (`location_id`) REFERENCES `locations` (`id`) ON DELETE SET NULL;
